    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-slate-500 text-sm">Crie, edite e configure os planos e benefícios do RotinaPed.</p>
        </div>
        <button 
        ...
        <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4">
          <div className="bg-white w-full max-w-lg rounded-2xl shadow-2xl overflow-hidden animate-in fade-in zoom-in-95 duration-200 flex flex-col max-h-[90dvh]">
            ...
            <form onSubmit={handleSavePlan} className="flex-1 overflow-y-auto p-6 space-y-4">
              ...
              {/* Descrição */}
              <div className="space-y-1">
                <label className="text-xs font-semibold text-slate-600 block">Descrição Resumida</label>
                <textarea
                  placeholder="Explique resumidamente o foco deste plano..."
                  rows={2}
              ...
              {/* Preço Inteligente & ID Externo */}
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {/* Preço inteligente */}
                <div className="space-y-1">
                  <label className="text-xs font-semibold text-slate-600 block">Valor do Plano (R$) *</label>
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-9 pr-4 py-2.5 border border-slate-200 rounded-xl text-sm bg-slate-50/50 focus:outline-none focus:ring-2 focus:ring-[#1b6392]/20 focus:border-[#1b6392] font-semibold text-slate-800 text-left"
                    />
                  </div>
